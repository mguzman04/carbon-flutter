...
@immutable
class CarbonTheme extends ThemeExtension<CarbonTheme> {
  ...
  @override
  CarbonTheme lerp(ThemeExtension<CarbonTheme>? other, double t) {
    if (other is! CarbonTheme) {
      return this;
    }
    return CarbonTheme(
  ...
  static const white = CarbonTheme(
  ...
  static const gray100 = CarbonTheme(
